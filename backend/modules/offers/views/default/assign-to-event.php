...
<div class="offer-index">
    ...
    <p>
        <?php echo Html::a(Html::icon('arrow-left').Yii::t('app', 'Powrót do ').$event->name, ['/event/view', 'id'=>$event->id, '#'=>'tab-offer'], ['class'=>'btn btn-primary']); ?>
    </p>
    <div class="grid">
...
<?php
$eventGearUrl = Url::to(['/offer/default/offer-event', 'event_id'=>$event->id]);
$this->registerJs('
