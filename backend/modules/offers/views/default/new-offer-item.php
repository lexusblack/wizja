...
?>
    ...
    <div class="offer-extra-item-form">
        ...
        <?= $form->field($model, 'time_type', ['labelOptions' => ['id' => 'label_time']])->dropDownList($model->offer->getScheduleList(), ['prompt' => 'Wybierz', 'id' => 'input_time']) ?>
...
$this->registerJs('
    $("#active-form").submit(function(e)
    {
        ...
        if ($("#type_dropdown").val() == '.OfferExtraItem::TYPE_VEHICLE.') {
            if($("#input_time").val()=="")
            {
                alert("Pole etap nie może pozostać puste");
                return false;
            }
        }
        
        if ($("#type_dropdown").val() == '.OfferExtraItem::TYPE_CREW.') {
            if($("#input_time").val()=="")
            {
                alert("Pole etap nie może pozostać puste");
                return false;
    ...
    $("#type_dropdown").change(function(){
        ...
        if ($(this).val() == '.OfferExtraItem::TYPE_GEAR.') {
        ...
        if ($(this).val() == '.OfferExtraItem::TYPE_VEHICLE.') {
        ...
        if ($(this).val() == '.OfferExtraItem::TYPE_CREW.') {
            label_price.html("Cena");
            label_duration.html("Dni pracy");
            input_category.slideUp();
            label_category.slideUp();
