...
<h3><?php echo Yii::t('app', 'Kosztorysy'); ?></h3>
<div class="row">
    <div class="col-md-12">
            <div class="ibox">
        <?php
        ...
        if ($user->can('eventEventEditEyeAttachmentAdd')) {
            echo Html::a(Html::icon('plus') . ' ' . Yii::t('app', 'Dodaj'), ['estimate/create', 'eventId' => $model->id], ['class' => 'btn btn-success']);
        } ?>
...
<div class="row">
    <div class="col-md-12">
        ...
        echo GridView::widget([
            'dataProvider'=>$model->getAssignedEstimates(),
            'tableOptions' => [
