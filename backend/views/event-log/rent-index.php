...
$this->title = 'Historia logów wypożyczeń';
...
<?=Html::a('Historia logów wydarzeń', ['/event-log/index'], ['class'=>'btn btn-info'])?>
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Wypożyczenie', 'id' => 'grid--rent_id']
            ],
