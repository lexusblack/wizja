...
<div class="user-note-index">
    ...
    <p>
        <?= Html::a('Create User Note', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid--creator_id']
            ],
        'datetime',
        'name:ntext',
        [
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-user-note']],
        'panel' => [
