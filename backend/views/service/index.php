...
<div class="service-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filter' => \yii\helpers\ArrayHelper::map(\common\models\ServiceCategory::find()->asArray()->all(), 'id', 'name'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Kategoria', 'id' => 'grid-service-search-service_category_id']
            ],
        [
            'attribute'=>'in_offer',
            'value'=>function($model)
