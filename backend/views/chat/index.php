...
<div class="chat-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Stwórz Chat'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => Yii::t('app', 'Użytkownik'), 'id' => 'grid-chat-search-create_by']
            ],
        [
                'attribute' => 'event_id',
                ...
                'filterInputOptions' => ['placeholder' => Yii::t('app', 'Wydarzenie'), 'id' => 'grid-chat-search-event_id']
            ],
        [
    ...
    <?= GridView::widget([
        ...
        'columns' => $gridColumn,
        'pjax' => true,
        'pjaxSettings' => ['options' => ['id' => 'kv-pjax-container-chat']],
        'panel' => [
