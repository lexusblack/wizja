...
<div class="row">
    <div class="col-md-12">
        <?php echo Html::a(Yii::t('app', 'Dodaj'), ['/customer-note/create',  'customer_id'=>$model->id], ['class'=>'btn btn-success']); ?>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
                                 ...
                                 <?php       
                                    foreach ($model->customerNotes as $m)
                                        ...
                                        <div class="media-body ">
                                            ...
                                            <?php } ?>
                                            <div class="actions">
                                            <?php if (isset($m->next_date)){ echo '<span class="label label-primary"><i class="fa fa-calendar"></i> '.substr($m->next_date, 0, 10)."</span>"; } ?>
                                            <?php if (isset($m->event)){ echo Html::a('<i class="fa fa-star"></i> '.$m->event->name, ['/event/view', 'id'=>$m->event_id], ['class'=>'btn btn-xs btn-primary']); } ?>
                                            <?php if (isset($m->offer)){ echo Html::a('<i class="fa fa-shopping-cart"></i> '.$m->offer->name, ['/offer/default/view', 'id'=>$m->offer_id], ['class'=>'btn btn-xs btn-primary']); } ?>
