            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title  navy-bg">
                            <h5><?=Yii::t('app', 'Zadania')?></h5>
                                    ...
                                    <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('app', 'Dodaj zadanie'), ['/task/create', 'customer_id'=>$model->id], ['class'=>'white-button add-service']); ?>
                                    <?php } ?>
...
<script type="text/javascript">
    ...
    {
        $.post('/admin/task/small-view?type=customer&id='+data.id, data, function(response){
