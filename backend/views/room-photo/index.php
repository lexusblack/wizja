...
/* @var $searchModel common\models\RoomPhotoSearch */
...
<div class="room-photo-index">
    ...
    $gridColumn = [
        ...
        [
                ...
                'filter' => \yii\helpers\ArrayHelper::map(\common\models\Room::find()->asArray()->all(), 'id', 'name'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' =>  Yii::t('app', 'Pokój'), 'id' => 'grid-room-photo-search-room_id']
            ],
        'mime_type',
        'base_name',
        [
