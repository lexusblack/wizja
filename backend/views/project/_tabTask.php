...
<?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('app', 'Dodaj grupę zadań'), ['/task/create-cat', 'project_id'=>$model->id], ['class'=>'btn btn-primary add-service-category'])." "; ?>  
        <div class="row">
        <div class="col-sm-6">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title  navy-bg" style="background-color:<?=$category->color?>">
                            <h5><?=$category->name?></h5>
                                    ...
                                    <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('app', 'Dodaj zadanie'), ['/task/create', 'category_id'=>$category->id, 'project_id'=>$model->id], ['class'=>'white-button add-service']); ?>
                                    <?php } ?>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title  navy-bg">
                            <h5><?=Yii::t('app', 'Pozostałe')?></h5>
                                    <div class="ibox-tools white">
                                    <?php if ($user->can('menuTasksAdd')) { ?>
                                    <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('app', 'Dodaj zadanie'), ['/task/create', 'project_id'=>$model->id], ['class'=>'white-button add-service']); ?>
                                    <?php } ?>
                                    <a class="collapse-link">
                                        <i class="fa fa-chevron-up"></i>
                                    </a>
