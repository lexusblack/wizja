<div class="form-group" id="add-agency-offer">
<?php
...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'offer_date' => ['type' => TabularForm::INPUT_WIDGET,
            'widgetClass' => \kartik\datecontrol\DateControl::classname(),
            'options' => [
                'type' => \kartik\datecontrol\DateControl::FORMAT_DATETIME,
                'saveFormat' => 'php:Y-m-d H:i:s',
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowAgencyOffer(' . $key . '); return false;', 'id' => 'agency-offer-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . 'Add Agency Offer', ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowAgencyOffer()']),
        ]
    ]
]);
echo  "    </div>\n\n";
