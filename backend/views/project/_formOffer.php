...
echo TabularForm::widget([
    ...
    'attributes' => [
        ...
        'term_from' => ['type' => TabularForm::INPUT_TEXT],
        'term_to' => ['type' => TabularForm::INPUT_TEXT],
        'page' => ['type' => TabularForm::INPUT_TEXT],
        'manager_id' => [
            'label' => 'User',
            'type' => TabularForm::INPUT_WIDGET,
            'widgetClass' => \kartik\widgets\Select2::className(),
        ...
        'offer_date' => ['type' => TabularForm::INPUT_TEXT],
        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  'Delete', 'onClick' => 'delRowOffer(' . $key . '); return false;', 'id' => 'offer-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
