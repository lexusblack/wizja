...
<div class="customer-index">
            ...
            <div class="col-md-12">
             ...
             <h2><?=Yii::t('app', 'Import sprzętu')?></h2>
                <p><?=Yii::t('app', 'Zaimportuj swój sprzęt z magazynu do systemu. Aby tego dokonać przygotuj plik .xlsx według')?>  <?=Html::a(Yii::t('app', 'schematu'),'/files/gear.xlsx')?> <?=Yii::t('app', 'i wczytaj go ponizej.')?></p>
