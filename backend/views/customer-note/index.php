...
/* @var $searchModel common\models\CustomerNoteSearch */
...
?>
<div class="customer-note-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a('Create Customer Note', ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Customer', 'id' => 'grid-customer-note-search-client_id']
            ],
        [
                'attribute' => 'event_id',
                'label' => 'Event',
                ...
                'filterInputOptions' => ['placeholder' => 'Event', 'id' => 'grid-customer-note-search-event_id']
            ],
        [
                'attribute' => 'rent_id',
                'label' => 'Rent',
                ...
                'filterInputOptions' => ['placeholder' => 'Rent', 'id' => 'grid-customer-note-search-rent_id']
            ],
        [
