...
<div class="customer-note-form">
    ...
    <?php echo $form->field($model, 'name')->widget(\common\widgets\RedactorField::className()); ?>
    ...
    <?= $form->field($model, 'next_date')->widget(\kartik\datecontrol\DateControl::classname(), [
