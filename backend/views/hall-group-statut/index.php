...
use kartik\export\ExportMenu;
    $this->title = Yii::t('app', 'Statusy rezerwacji powierzchni');
...
<div class="offer-statut-index">
        <div>
        <?= Html::a('<i class="fa fa-plus"></i> '.Yii::t('app', 'Dodaj status'), ['create'], ['class'=>'btn btn-primary'])." "; ?>            
        </div>
<div class="row">
<div class="col-xs-12">
<div class="ibox">
...
$( function() {
    ...
    update: function (event, ui) {
        ...
        $.ajax({
            data: data,
            type: 'POST',
            url: '".Url::to(['/hall-group-statut/order'])."'
        });
    }
});
