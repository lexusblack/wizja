...
/**
 * common\models\LocationPanoramaSearch represents the model behind the search form about `common\models\LocationPanorama`.
 */
 class LocationPanoramaSearch extends LocationPanorama
{
    /**
     * @inheritdoc
     */
