...
/**
 * EventInvoiceSearch represents the model behind the search form about `common\models\EventInvoice`.
 */
class EventInvoiceSearch extends EventInvoice
{
    /**
     * @inheritdoc
     */
