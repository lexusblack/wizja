...
/**
 * common\models\LocationPhotoSearch represents the model behind the search form about `common\models\LocationPhoto`.
 */
 class LocationPhotoSearch extends LocationPhoto
{
    /**
     * @inheritdoc
     */
