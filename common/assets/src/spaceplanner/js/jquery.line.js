...
(function($) {
  ...
  var helpers = {
    createLine: function(x1, y1, x2, y2, options, div = null){
      ...
      var line = div === null ? document.createElement("div") : div;
  ...
  $.fn.redraw = function(x1, y1, x2, y2, options, cb) {
    options = $.extend({}, $.fn.line.defaults, options);
    var line = helpers.createLine(x1,y1,x2,y2, options, $(this)[0]);
    cb(line);
  }
  ...
  $.fn.line = function( x1, y1, x2, y2, options, callbacks) {
    return $(this).each(function(){
      ...
      options = $.extend({}, $.fn.line.defaults, options);
      var line = helpers.createLine(x1,y1,x2,y2,options);
